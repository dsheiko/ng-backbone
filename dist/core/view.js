...
var View = (function (_super) {
    ...
    View.prototype._bindModels = function () {
        ...
        this.models.forEach(function (model) {
            ...
            _this.trigger("log:listen", "subscribes for `change`", model);
    ...
    View.prototype._bindCollections = function () {
        ...
        this.collections.forEach(function (collection) {
            ...
            _this.trigger("log:listen", "subscribes for `change destroy sync`", collection);
    ...
    View.prototype.render = function (source) {
        ...
        try {
            var errors = this.template.sync(scope).report()["errors"];
